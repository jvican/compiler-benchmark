 ...
 */
case class CurrencyExchangeRate(base: Money, counter: Money)
    extends Ratio[Money, Money] {
  require(base.currency != counter.currency,
  ...
  def convert(money: Money) = money.currency match {
    ...
    case _ =>
      throw new IllegalArgumentException(
          "The currency of money must match the currency of base or counter")
  }
