...
object Dimensionless extends Dimension[Dimensionless] {
  def apply[A](n: A, unit: DimensionlessUnit)(implicit num: Numeric[A]) =
    new Dimensionless(num.toDouble(n), unit)
  def apply = parse _
 ...
 */
trait DimensionlessUnit
    extends UnitOfMeasure[Dimensionless]
    with UnitConverter {
...
object DimensionlessConversions {
  ...
  implicit object DimensionlessNumeric
      extends AbstractQuantityNumeric[Dimensionless](Dimensionless.primaryUnit) {
