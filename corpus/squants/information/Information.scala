...
object Information extends Dimension[Information] with BaseDimension {
  private[information] def apply[A](n: A, unit: InformationUnit)(
      implicit num: Numeric[A]) = new Information(num.toDouble(n), unit)
  def apply = parse _
...
object InformationConversions {
  ...
  implicit object InformationNumeric
      extends AbstractQuantityNumeric[Information](Information.primaryUnit)
}
